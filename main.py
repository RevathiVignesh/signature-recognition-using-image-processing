...
class image:
    ...
    def __init__(self, src):
        ...
        self.left_ = self.final_image[:, 0:int(self.X_COG)]
        self.right_ = self.final_image[:, int(self.X_COG):]
    ...
    def display_data(self):
        ...
        print
        "Normalised Area", self.normalised_area
        print
        "Centre of Gravity(Y,X)", self.Y_COG, self.X_COG
        print
        "Normalised Signature height", self.normalised_signature_height
        print
        "Baseline Shift", self.baseline_shift
        print
        "Maximum Height", self.H_max
        print
        "Maximum width", self.W_max
...
class feature_vector:
    ...
    def __init__(self, image):
        self.vector = np.array(
            [image.aspectratio, image.normalised_area, image.X_COG, image.Y_COG, image.normalised_signature_height,
             image.baseline_shift, image.H_max, image.W_max])
...
try:
    test_image = image(input("Enter the file name of the test file "))
    ...
    print("File not found. Terminating",e)
